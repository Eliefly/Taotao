...
<head>
	...
	<script type="text/javascript">
		...
		function submitItem(){
			var num = $("#buy-num").val();
    		window.location.href= "http://www.taotao.com/cart/${item.id}?num="+num;
    	}
	</script>
</head>
<body version="140120">
			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn">
							...
							<a class="btn-append " id="InitCartUrl" onclick="submitItem()" clstag="shangpin|keycount|product|initcarturl">加入购物车<b></b></a>
					</div>
